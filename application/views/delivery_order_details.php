 ...
 <!--form  id="form1" class="form-horizontal" action="<?php //echo site_url("sales_order_detail/home/sales_order_detail_add/$id/$scid"); ?>" method="post"-->
  ...
  <div class="panel-body">
    ...
    ?>
		...
		<form action="<?php echo site_url('sales_order_detail/home/delivery_order_report/'.$id.'/'.$scid); ?>" ><input type=submit value=Cetak ></form>	
		<form action="<?php echo site_url('sales_order_detail/home/delivery_order/'.$id.'/'.$scid); ?>" ><input type=submit value=Update ></form>		
    <?php //echo $pages; ?>
                            </div>
                        </div>
