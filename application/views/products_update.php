...
<input type="hidden" name="id" value="<?php echo $id; ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-lg-4">
                        <input type="text" style="text-align:right;" placeholder="Cash Discount" name="disc" class="form-control" value="<?php echo $detail[0] -> pdisc; ?>" /> <span class="input-group-addon">%</span>
                    </div>
                </div>
                <div class="form-group">
