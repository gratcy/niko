       <!--PAGE CONTENT -->
        <div id="content">
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Price <?php echo __get_price_type($type);?> Add</h1>
                </div>
            </div>
<div class="row">
<div class="col-lg-12">
    <div class="box dark">
        <header>
            ...
            <h5>Price <?php echo __get_price_type($type);?> Add</h5>
        </header>
        <div id="div-1" class="accordion-body collapse in body">
	<?php echo __get_error_msg(); ?>
            <form class="form-horizontal" action="<?php echo site_url('price/price_add'); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        <input type="text" name="moq" class="form-control" style="text-align:right;" onkeyup="formatharga(this.value,this)" value="0" />
                    </div>
                </div>
