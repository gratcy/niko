       ...
       <!--PAGE CONTENT -->
        <div id="content">
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Chart of Account Group Update</h1>
                </div>
            </div>
<div class="row">
<div class="col-lg-12">
    <div class="box dark">
        <header>
            ...
            <h5>Chart of Account Group Update</h5>
        </header>
        <div id="div-1" class="accordion-body collapse in body">
	<?php echo __get_error_msg(); ?>
            <form class="form-horizontal" action="<?php echo site_url('coagroup/coagroup_update'); ?>" method="post">
            <input type="hidden" name="id" value="<?php echo $id; ?>">
                <div class="form-group">
                    <label for="text1" class="control-label col-lg-4">Class</label>

                    <div class="col-lg-4">
                        <select name="class" class="form-control"><?php echo __get_coa_class($detail[0] -> cclass,2); ?></select>
                    </div>
                </div>
