...
<table border=0 width=90% ><tr><td width=50%>
                ...
                <div class="form-group">
					...
					$nodo=$id.'-'.date('dmyhis');
					?>
					<input type=text value="<?php echo 'INV-'.$nodo;?>" class="form-control" disabled>
					<input type=hidden value="<?php echo 'INV-'.$nodo;?>" name=sno_invoice class="form-control" >
                    </div>
                </div>			
                ...
                <div class="form-group">
					...
					<div class="col-lg-4">
						<input  name="stgl_invoice" type="text" placeholder="click to show datepicker"  id="example1" class="form-control"  >
					</div> 							
                </div>
