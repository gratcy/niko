<script>
	...
	console.log(ahs);
		...
		<tr><td>Request No. / Vendor</td><td><?php echo (__get_receiving_name($detail[0] -> riid, $detail[0] -> rtype) ? __get_receiving_name($detail[0] -> riid, $detail[0] -> rtype) : $detail[0] -> rvendor);?></td></tr>
