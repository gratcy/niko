...
class Home extends MY_Controller {
	...
	function delivery_order($id,$scid) {
		if ($_POST) {
			...
			$arr = array('sid' => $sid, 'scid' => $scid, 'scid' => $snodo, 'snodo' => $scid, 'snopol' => $snopol, 'stgldo' => $stgldo, 'snomor' => $snomor	);						
	...
	function invoice_order_add($id,$scid,$snodo) {
		...
		if ($_POST) {
			...
			$arr = array('sno_invoice' => $sno_invoice, 'stgl_invoice' => $stgl_invoice,'sduedate_invoice' => $sduedate_invoice,'kurang_bayar'=>$juminv	);						
