...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2014 at 09:11 AM
...
(1, 1, 1, 2, 3, 'palma', ' jakarta* semarang', 1, 1, 0, '909090*232323*1212', 'gratcypalma@gmail.com', 'asasa', 3, 10, 15, 1500000, '1212', '1aa', 1, 0, 1),
(2, NULL, NULL, 2, 0, 'Bareksa Portal Investasi', '          jakarta*          bandung', 2, 3, 0, '8798798979*8799898798*2333', 'gratcypalma@gmail.com', 'asasa', 2, 5, 10, 989970, '86788767', '1aa', 0, 0, 1),
(3, NULL, NULL, 2, 2, 'AAA', 'JAKARTA*JAKARTA', 1, 2, 2, '09900*566778*', 'ariessandi7@gmail.com', 'aaa', 2, 10, 20, 30, '877979879', '989809', 1, 0, 1),
...
INSERT INTO `delivery_order_detail_tab` (`did`, `sid`, `ssid`, `spid`, `sqty`, `snodo`, `snopol`, `stgldo`, `snomor`, `driver`, `dstatus`) VALUES
(47, 0, 18, 0, 0, '999', 'AB', '2014-11-05', '23456', '', 0),
(48, 22, 18, 1, 5, '999', 'AB', '2014-11-05', '23456', '', 0),
(49, 23, 18, 1, 2, '999', 'AB', '2014-11-05', '23456', '', 0),
(50, 0, 21, 0, 0, '21-111114045149', 'AB 567 D', '2014-11-11', '12345', 'saya', 1),
(53, 27, 21, 1, 4, '21-111114045149', 'AB 567 D', '2014-11-11', '12345', '', 1);
...
--
-- Table structure for table `log_inventory_tab`
--
...
--
-- Dumping data for table `log_inventory_tab`
--
...
(27, 0, 6, 0, '', 0, 0, 0, '', 1, '4-054203'),
(28, 9, 6, 1, 'IDR', 7, 10000, 0, 'ok', 1, '4-054203'),
(29, 10, 6, 1, 'IDR', 4, 10000, 0, 'ok', 1, '4-054203'),
(30, 0, 5, 0, '', 0, 0, 0, '', 1, '3-073046'),
(31, 14, 5, 1, 'IDR', 5, 10000, 0, 'ok', 1, '3-073046'),
(32, 15, 5, 1, 'IDR', 5, 10000, 0, 'ok', 1, '3-073046');
...
(8, 5, 1, 'IDR', 5, 10000, 0, '', 0, 5),
(9, 6, 1, 'IDR', 7, 10000, 0, 'ok', 0, 0),
(10, 6, 1, 'IDR', 4, 10000, 0, 'ok', 1, 0),
(11, 6, 1, 'IDR', 5, 10000, 0, 'ok', 1, 5),
(12, 5, 2, 'IDR', 4, 111, 0, 'ok', 0, 4),
(13, 5, 1, 'IDR', 7, 10000, 0, 'ok', 0, 7),
(14, 5, 1, 'IDR', 5, 10000, 0, 'ok', 1, 0),
(15, 5, 1, 'IDR', 5, 10000, 0, 'ok', 1, 0);
...
(4, 2, '2', 'vvv', '2014-11-04', 3, 'aasas', 0, '2014-11-03', 0, 'in', 0, 0, 0, 0, 0),
(5, 2, '3', 'zzz', '2014-11-04', 0, 'aasas', 3, '2014-11-03', 0, 'in', 0, 0, 0, 0, 0),
(6, 2, '4', 'Kuda', '2014-11-11', 0, 'Bali Dua', 2, '2014-11-11', 0, 'in', 0, 0, 0, 0, 0);
...
INSERT INTO `retur_tab` (`rid`, `rbid`, `rnoretur`, `snopo`, `sreff`, `stgl`, `scid`, `stype`, `ssid`, `sppn`, `sfreeppn`, `sstatus`, `scdate`, `sketerangan`, `sduedate`, `stypepay`) VALUES
...
(19, 2, '3', '', 'sansan', '2014-11-06', 2, '', 2, '1', 1, 3, '2014-11-06', 'ok', '2014-11-16', 'auto');
...
INSERT INTO `sales_order_detail_tab` (`sid`, `ssid`, `spid`, `sqty`, `sprice`, `sdisc`, `ssisa`, `status`) VALUES
(19, 16, 1, 9, 500000, 0, 8, 1),
(20, 16, 2, 3, 10, 0, 2, 1),
(22, 18, 1, 9, 100000, 0, 4, 1),
(23, 18, 1, 12, 100000, 0, 10, 1),
(24, 20, 1, 8, 100000, 0, 8, 1),
(26, 16, 1, 8, 100000, 0, 8, 1),
(27, 21, 1, 9, 100000, 0, 9, 1),
(30, 22, 1, 11, 100000, 0, 11, 1);
...
(16, 2, '15', '', 'ggg', '2014-11-04', 2, '', 2, '1', 1, 3, '2014-11-04', 'ok', '2014-11-14', 'auto'),
(18, 2, '2', '', 'sandi', '2014-11-05', 2, '', 2, '1', 1, 3, '2014-11-05', 'ok', '2014-11-15', 'auto'),
(19, 1, '1', '', '', '0000-00-00', 0, '', 0, '1', 1, 2, '2014-11-11', '            ', NULL, ''),
(20, 1, '3', '', 'bbb', '2014-11-11', 2, '', 2, '1', 1, 3, '2014-11-10', '', '2014-11-20', 'auto'),
(21, 1, '4', '', 'Abcde', '2014-04-03', 2, '', 2, '1', 1, 3, '2014-11-11', '            ok            okkkk                   ', '2014-11-21', 'auto'),
(22, 1, '2', '', 'aaa', '2014-10-28', 2, '', 2, '0', 0, 3, '2014-11-11', 'ok                                    ', '2014-11-21', 'credit');
...
(1, 1, 1, 'admin@admin.com', NULL, NULL, 'e89591ee9b8e7018511649a2146ae279', '2130706433*1415686341', 1),
(2, 2, 2, 'admin@dluxor.com', 'web', 'programmer', 'e89591ee9b8e7018511649a2146ae279', '2130706433*1415679651', 1),
(4, 2, 4, 'niko@niko.com', 'design', NULL, 'design', NULL, 1),
(5, 0, 3, 'niko2@niko.com', '6f83286fce007c0cb22aa2beaae66165', NULL, '2', NULL, 0),
(6, 1, 4, 'niko3@niko.com', 'web', NULL, '6f83286fce007c0cb22aa2beaae66165', NULL, 1),
(7, 2, 4, 'niko4@niko.com', 'design', 'programmer', '6f83286fce007c0cb22aa2beaae66165', NULL, 1);
